...
Vehicle.create(plate: 'ABC123', trademark: 'Toyota')
Vehicle.create(plate: 'DEF123', trademark: 'Nissan')
Vehicle.create(plate: 'GHI123', trademark: 'Mazda')
Vehicle.create(plate: 'JKL123', trademark: 'Hyundai')
Vehicle.create(plate: 'MNO123', trademark: 'Kia')
...
User.create(name:'Alfredo Vasquez', email: 'vasquez.alf@gmail.com', username: 'Alfredo', password: 'argosbuffy', password_confirmation: 'argosbuffy', roles_mask: 1)