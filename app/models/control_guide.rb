class ControlGuide < ApplicationRecord
  ...
  validates_presence_of :control_guide_number, message: "Debe ingresar el número de guía de remisión"
  ...
  has_many :control_guide_details, dependent: :destroy
  accepts_nested_attributes_for :control_guide_details, allow_destroy: true
end
