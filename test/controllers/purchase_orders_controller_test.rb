...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { billing_address: @purchase_order.billing_address, business_id: @purchase_order.business_id, date: @purchase_order.date, delivery_address: @purchase_order.delivery_address, delivery_date: @purchase_order.delivery_date, order_date: @purchase_order.order_date, order_number: @purchase_order.order_number, supplier_id: @purchase_order.supplier_id }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { billing_address: @purchase_order.billing_address, business_id: @purchase_order.business_id, date: @purchase_order.date, delivery_address: @purchase_order.delivery_address, delivery_date: @purchase_order.delivery_date, order_date: @purchase_order.order_date, order_number: @purchase_order.order_number, supplier_id: @purchase_order.supplier_id }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
