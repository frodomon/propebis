...
class SettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setting" do
    assert_difference('Setting.count') do
      post settings_url, params: { setting: { expiration_alert: @setting.expiration_alert } }
    end
  ...
  test "should update setting" do
    patch setting_url(@setting), params: { setting: { expiration_alert: @setting.expiration_alert } }
